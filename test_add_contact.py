...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(u"Алена", u"Николаевна", u"Пашкова", "alena", u"нет", u"АСТА",
    ...
    def create_contact(self, wd, contact):
        ...
        Select(wd.find_element_by_name("amonth")).select_by_visible_text(contact.amounth)
        wd.find_element_by_name("amonth").click()
