...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, u"Алена", u"Николаевна", u"Пашкова", "alena", u"нет", u"АСТА",
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, homephone,
                       mobilephone, workphone, fax, email, email2, email3, homepage, bday, bmonth, byear, aday, amounth,
        ...
        Select(wd.find_element_by_name("amonth")).select_by_visible_text(amounth)
        wd.find_element_by_name("amonth").click()
